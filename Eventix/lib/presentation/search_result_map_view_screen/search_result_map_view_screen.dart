...
class SearchResultMapViewScreen
    extends GetWidget<SearchResultMapViewController> {
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        CustomImageView(
                          ...
                          height: getSize(24.00),
                          width: getSize(24.00),
                          margin: getMargin(left: 16, right: 24),
                          onTap: () => Get.bottomSheet(
                              FilterBottomsheet(Get.put(FilterController())),
